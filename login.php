          ...
          let pswstr = $('#pwd').val();
            ...
            $.ajax({
              ...
              success: function(data){
                    if(data.username == emailstr &&
                    data.password == pswstr){
                      window.location.replace("/todopage.php");
                } else {
                  $(".form-frame").append("<p style='color:red'>Nav pareizi rekvizīti!</p>");
                };
              },
